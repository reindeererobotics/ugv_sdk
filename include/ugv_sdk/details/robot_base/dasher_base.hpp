...
void ParseCANFrame(can_frame *rx_frame) {
    ...
    if (parser_.DecodeMessageRDRE(rx_frame, &status_msg)) {
...
void UpdateRobotCoreState(const ReindeereMessage &status_msg) {
    ...
    switch (status_msg.agx.type) {
      case AgxMsgSystemState: {
        ...
        core_state_msgs_.system_state = status_msg.agx.body.system_state_msg;
        break;
      }
      case AgxMsgMotionState: {
        // std::cout << "motion control feedback received" << std::endl;
        core_state_msgs_.time_stamp = westonrobot::SdkClock::now();
        core_state_msgs_.motion_state = status_msg.agx.body.motion_state_msg;
        break;
      }
      case AgxMsgLightState: {
        // std::cout << "light control feedback received" << std::endl;
        core_state_msgs_.time_stamp = westonrobot::SdkClock::now();
        core_state_msgs_.light_state = status_msg.agx.body.light_state_msg;
        break;
      }
      case AgxMsgMotionModeState: {
        ...
        core_state_msgs_.motion_mode_state =
            status_msg.agx.body.motion_mode_state_msg;
        break;
      }
      case AgxMsgRcState: {
        // std::cout << "rc feedback received" << std::endl;
        core_state_msgs_.time_stamp = westonrobot::SdkClock::now();
        core_state_msgs_.rc_state = status_msg.agx.body.rc_state_msg;
        break;
      }
      default:
        break;
    ...
    switch (status_msg.agx.type) {
      case AgxMsgMotorAngle: {
        actuator_state_msgs_.motor_angles.angle_5 =
            status_msg.agx.body.motor_angle_msg.angle_5;
        actuator_state_msgs_.motor_angles.angle_6 =
            status_msg.agx.body.motor_angle_msg.angle_6;
        actuator_state_msgs_.motor_angles.angle_7 =
            status_msg.agx.body.motor_angle_msg.angle_7;
        actuator_state_msgs_.motor_angles.angle_8 =
            status_msg.agx.body.motor_angle_msg.angle_8;
        break;
      }
      case AgxMsgMotorSpeed: {
        actuator_state_msgs_.motor_speeds.speed_1 =
            status_msg.agx.body.motor_speed_msg.speed_1;
        actuator_state_msgs_.motor_speeds.speed_2 =
            status_msg.agx.body.motor_speed_msg.speed_2;
        actuator_state_msgs_.motor_speeds.speed_3 =
            status_msg.agx.body.motor_speed_msg.speed_3;
        actuator_state_msgs_.motor_speeds.speed_4 =
            status_msg.agx.body.motor_speed_msg.speed_4;
        break;
      }
      ...
      case AgxMsgActuatorLSState: {
        ...
        actuator_state_msgs_.time_stamp = westonrobot::SdkClock::now();
        actuator_state_msgs_
            .actuator_ls_state[status_msg.agx.body.actuator_ls_state_msg.motor_id] =
            status_msg.agx.body.actuator_ls_state_msg;
        break;
      }
      case AgxMsgActuatorStateV1: {
        ...
        actuator_state_msgs_.time_stamp = westonrobot::SdkClock::now();
        actuator_state_msgs_
            .actuator_state[status_msg.agx.body.v1_actuator_state_msg.motor_id] =
            status_msg.agx.body.v1_actuator_state_msg;
        break;
      }
      default:
        break;
...
void UpdateResponseVersion(const ReindeereMessage &status_msg) {
    switch (status_msg.agx.type) {
      case AgxMsgVersionResponse: {
        ...
        for (int i = 0; i < 8; i++) {
          uint8_t data = status_msg.agx.body.version_response_msg.bytes[i];
